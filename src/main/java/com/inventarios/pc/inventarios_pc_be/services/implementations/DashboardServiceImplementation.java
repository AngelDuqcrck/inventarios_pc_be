...
public class DashboardServiceImplementation implements IDashboardService{
    ...
    public DashboardResponse listDashboard(){
        ...
        dashboardResponse.setNombre6("Lector CD");

        dashboardResponse.setCantidad1(0); //EQUIPOS PC LISTAR
        ...
        dashboardResponse.setCantidad6(dispositivoRepository.findByTipoDispositivo(tipoDispositivoRepository.findById(8).orElse(null)).size());
